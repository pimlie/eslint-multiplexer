 ...
 */
const belowThreshold = function (options, result, message) {
...
module.exports = function (results, options) {
  ...
  results.forEach((result) => {
    ...
    let fileTable = `${table(
      messages
        .filter(message => !options.hideBelowThreshold || !belowThreshold(options, result, message))
        .map((message) => {
          const isBelowThreshold = belowThreshold(options, result, message)
